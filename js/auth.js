...
function renderSidebar(perfil, activePage) {
  ...
  const showRrhh = isAdmin ||
    ...
    puedeVer(perfil,'rrhh_vacaciones');
    ...
    <aside class="sidebar" id="sidebar">
      ...
      <nav class="sidebar-nav">
        ...
        <div class="nav-section">
          ...
          ${puedeVer(perfil,'rrhh_vacaciones') ? `<a href="/pages/rrhh/vacaciones.html" class="nav-item ${activePage==='vacaciones'?'active':''}"><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M3 17l4-8 4 4 4-6 4 10"/><path d="M3 21h18"/></svg> Vacaciones</a>` : ''}
        ...
        <div class="nav-section">
          ...
          <a href="/pages/reservas/plano-salon.html" class="nav-item ${activePage==='plano-salon'?'active':''}">
            <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="3" y="3" width="18" height="18" rx="2"/><line x1="3" y1="9" x2="21" y2="9"/><line x1="9" y1="9" x2="9" y2="21"/></svg>
            Plano del salón
          </a>
        </div>
